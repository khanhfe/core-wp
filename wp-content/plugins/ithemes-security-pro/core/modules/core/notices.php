...
class ITSEC_Admin_Notice_New_Feature_Core implements ITSEC_Admin_Notice {
	...
	public function get_message() {
		...
		return sprintf(
			esc_html__( 'The new, improved %1$sWordPress Security Site Scan powered by iThemes checks if Google has detected malware and added your site to their blacklist', 'it-l10n-ithemes-security-pro' ),
			'<a href="{{ $blog }}">',
			'</a>'
		);
	}
